package com.magee.common.utils.rest;
...
public class RestUtil {
    ...
    public static String getDomain() {
        if (domain == null) {
            domain = ServletUtils.getDomain(ServletUtils.getRequest());
    ...
    public static String getPath() {
        if (path == null) {
            path = SpringUtils.getApplicationContext().getEnvironment().getProperty("server.servlet.context-path");
        }
        return ConvertUtils.toStr(path);
    }

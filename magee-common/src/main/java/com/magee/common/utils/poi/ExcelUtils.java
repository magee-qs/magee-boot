package com.magee.common.utils.poi;
...
import com.magee.common.utils.file.FileTypeUtils;
import com.magee.common.utils.file.FileUtils;
import com.magee.common.utils.file.ImageUtils;
...
public class ExcelUtils<T> {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    if (String.class == fieldType)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                val = DateUtils.toStr((Date) val, dateFormat );
                            }
                            else
                            {
                    ...
                    if (StringUtils.isNotNull(fieldType))
                    {
                        ...
                        ReflectUtils.setProperty(entity, propertyName, val);
                    }
                }
                list.add(entity);
            }
    ...
    public void writeSheet()
    {
        ...
        for (int index = 0; index <= sheetNo; index++)
        {
            ...
            {
                ExcelField excel = (ExcelField) os[1];
     ...
     * 获取画布
     */
    public  Drawing<?> getDrawingPatriarch(Sheet sheet)
    {
    ...
    public Cell addCell(ExcelField attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(DateUtils.toStr((Date) value,dateFormat ));
                }
     ...
     * 合计统计信息
     */
    private void addStatisticsData(Integer index, String text, ExcelField entity)
    {
     ...
     * @throws Exception
     */
    private Object getTargetValue(T vo, Field field, ExcelField excel) throws Exception
    {
    ...
    private void createExcelField()
    {
        ...
        this.fields = this.fields.stream().sorted(Comparator.comparing(objects -> ((ExcelField) objects[1]).sort())).collect(Collectors.toList());
